...
#ifndef COMMON_OPENQA_FAST_BORDES_TRAINER_H
#define COMMON_OPENQA_FAST_BORDES_TRAINER_H

// Local
#include "shared_defs.h"
#include "trainer.h"

class OpenQAFastBordesTrainer : public Trainer {
 public:
...
#endif  // COMMON_OPENQA_FAST_BORDES_TRAINER_H
